...
PARAMS = [
    ...
    # У каждой метрики свой порог и СВОЙ режим выше/ниже — комбинируются
    # независимо (например: ликвидаций стало меньше — не входить, а CVD-
    # всплеск больше — наоборот, сигнал силы).
    ("td_liq_prev_pct", "🌫 Ликвидации: окно vs пред., % (0-выкл)",
     ["0", "25", "50", "75", "100", "150"]),
    ("td_liq_prev_mode", "🌫 Ликвидации: не входить, если", ["below", "above"]),
    ("td_cvd_prev_pct", "🌫 CVD-поток: окно vs пред., % (0-выкл)",
     ["0", "25", "50", "75", "100", "150"]),
    ("td_cvd_prev_mode", "🌫 CVD: не входить, если", ["below", "above"]),
    ("td_oi_prev_pct", "🌫 OI: окно vs пред., % (0-выкл)",
     ["0", "25", "50", "75", "100"]),
    ("td_oi_prev_mode", "🌫 OI: не входить, если", ["below", "above"]),
...
_PRETTY = {
    "below": "🔻 Меньше порога (флет) — не входим",
    "above": "🔺 Больше порога (перегрев) — не входим",
